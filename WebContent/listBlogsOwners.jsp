			...
			<table class="table table-striped custab">
				<thead>
					<tr>
						...
						<th><fmt:message key="blog.blog_date_creation"
								bundle="${msg}" /></th>
						<th class="text-center"><input name='Voltar' type='button'
					...
					<c:forEach var="blog" items="${listBlogOwner}">
						<tr>
							...
							<td class="text-center"><a class='btn btn-info btn-xs'
								href="ServletBlog?action=InstancePublication&idBlog=${blog.idBlog}"><fmt:message
										key="button.button_view" bundle="${msg}" /></a></td>
						</tr>
					</c:forEach>
			</table>
		</div>
