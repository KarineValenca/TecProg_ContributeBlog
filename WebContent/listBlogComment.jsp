    ...
    <div class="row">
        ...
        <a href="?locale=pt_BR">Português</a>|<a href="?locale=en_US">English</a>
            <div class="panel-heading">
                ...
                <h3 class="panel-title"><fmt:message key="listBlogComment.recent_comments" bundle="${msg}"/></h3>
            </div>
            <div class="panel-body">
                ...
                <a href="#" class="btn btn-primary btn-sm btn-block" role="button"><span class="glyphicon glyphicon-refresh"></span><fmt:message key="listBlogComment.more_comments" bundle="${msg}"/></a>
            </div>
        </div>
    </div>
</div>
